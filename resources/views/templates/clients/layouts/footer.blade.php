                ...
                <div class="col-lg-4 col-md-4">
                    <div class="footer_widget">
                        ...
                        <div class="address_infos">
                            <ul>
                                <li><i class="fas fa-map-marker-alt"></i>Toàn quốc<br></li>
                                <li><i class="fas fa-phone-square"></i>0352757XXX</li>
                                <li><i class="fas fa-envelope"></i>Duongkhong12a4@gmail.com</li>
                            </ul>
                        </div>
